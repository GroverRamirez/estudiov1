...
import { type BreadcrumbItem, type Servicio, type ServicioFormData } from '@/types';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
        ...
        href: `/servicios/${props.servicio.idServicio}/edit`,
    },
];
...
const form = useForm({
    ...
    duracion_estimada: props.servicio.duracion_estimada || 60,
...
const submit = () => {
    ...
    form.put(`/servicios/${props.servicio.idServicio}`, {
        onSuccess: () => {
